                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日
                                <em style="color:rgb(247,76,49)">{{casenumDAta.currentConfirmedIncr>0 ? '+'+casenumDAta.currentConfirmedIncr : casenumDAta.currentConfirmedIncr}}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日
                                <em style="color:rgb(247,130,7)">{{ casenumDAta.suspectedIncr >0 ? "+"+casenumDAta.suspectedIncr : casenumDAta.suspectedIncr }}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日
                                <em style="color:rgb(162,90,78)">{{ casenumDAta.seriousIncr > 0 ? "+"+casenumDAta.seriousIncr : casenumDAta.seriousIncr }}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日
                                <em style="color:rgb(174, 33, 44)">{{ casenumDAta.confirmedIncr >0 ? "+"+casenumDAta.confirmedIncr : casenumDAta.confirmedIncr}}</em>
                            </b>
                        </div>
